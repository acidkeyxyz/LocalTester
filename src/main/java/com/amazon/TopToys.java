...
public class TopToys {
	...
	// 10:41 -11:24
	// given list of toys, get N tops ordered by number of matches and
	// alphabetically in case of match
	public static void main(String[] args) {
		String[] toys = { "woody", "shrek", "marshall", "pitufos", "barbies" };
		String[] reviews = { "woody is the best toy ever ", "woody is my favorite toy",
				"marshall from paw patrol is the best", "my marshall is the best, not pitufos",
	...
	private static List<String> getAllTopToys(String[] toys, int tops, String[] reviews) {
		...
		String allreviews = String.join(" ", reviews);
		String[] sreview = allreviews.split(" ");
